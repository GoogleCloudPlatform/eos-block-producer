...
# Deferred transactions sent by accounts in this list do not have any of the subjective allow/banned lists checks applied to them (may specify multiple times) (eosio::chain_plugin)
